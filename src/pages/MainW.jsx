    ...
    <main>
      ...
      <div className="greyField">
        <div className="textBlock">
          <p>
            Логистика для нас — это гораздо больше, чем доставка груза в
            сохранности из точки А в точку Б.
          </p>
          <p>
            Мы доставляем грузы из Китая, Европы и Турции, гарантируя нашим
      ...
      <div className="connector">
        ...
        <div>
          ...
          <p>
            У Вас есть возможность заполнить данную анкету, указать удобный для
            Вас способ связи и описать интересующий вопрос. Наш менеджер выйдет
            с Вами на связь в кратчайшие сроки!
          </p>
          <Connect />
        </div>
      </div>
